  ...
  public void reconcileContainer(DNContainerOperationClient dnClient, Container<?> container,
    ...
    try {
      ...
      for (DatanodeDetails peer : peers) {
        ...
        // then used to write the updated tree for the diff with the next peer.
      ...
      if (originalDataChecksum == latestDataChecksum) {
        LOG.info(
            "Completed reconciliation for container {} with {}/{} peers. Original data checksum {} was not updated",
